...
class SolutionTest extends TestCase
{
    ...
    {
        $this->assertEquals(1, countWins($this->winnersList, 'Portugal'));
        $this->assertEquals(0, countWins($this->winnersList, 'FootLand'));
        $this->assertEquals(9, countWins($this->winnersList, 'Spain'));
    }
}
